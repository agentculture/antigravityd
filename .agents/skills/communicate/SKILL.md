...
```bash
bash .agents/skills/communicate/scripts/mesh-message.sh \
    --channel "#general" \
...
```bash
bash .agents/skills/communicate/scripts/fetch-issues.sh 191 --repo agentculture/culture
bash .agents/skills/communicate/scripts/fetch-issues.sh 191-197 --repo agentculture/culture
bash .agents/skills/communicate/scripts/fetch-issues.sh 191 195 197
```
